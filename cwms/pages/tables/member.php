        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <a href="newvendor.php" class="btn btn-info">Create new member</a>
                        <div class="box-header">
                            <h3 class="box-title">All member</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <div id="printMe">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    while($test = mysqli_fetch_array($result))
                                    {
                                        ...
                                        echo"<td>" .$test['mfirstname']."</font></td>";
                                        //  echo"<td>" .$test['dateofbirth']."</font></td>";
                                        echo"<td>" .$test['mlastname']."</font></td>";

                                        echo"<td>" .$test['maddress']."</font></td>";
                                        echo"<td>" .$test['mphone']."</font></td>";
                                        echo"<td>" .$test['memail']."</font></td>";

                                        //echo"<td>" .$test['education']."</font></td>";
                                        //echo"<td>" .$test['martial']."</font></td>";
                                        echo"<td>" .$test['mroles']."</font></td>";
                                        echo"<td>" .$test['pan']."</font></td>";
                            ...
                            if(isset($_GET['delete_id']))
                            {
                                ...
                                $result=mysqli_query($conn,"DELETE FROM member where id ='$idd'");
